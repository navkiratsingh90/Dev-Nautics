...
// ── Inline SVG Icons (matching reference style) ─────────────────
const CodeIcon = () => (
...
const FeatureCard = ({ icon, title, description }: FeatureCardProps) => (
  <div className="bg-white border border-[#E8EDF2] rounded-2xl p-7 flex flex-col gap-3.5 transition-all hover:shadow-md">
...
const TestimonialCard = ({ name, role, avatar, text, tag }: TestimonialProps) => (
  <div className="bg-white border border-[#E8EDF2] rounded-2xl p-6 flex flex-col gap-4 transition-all hover:shadow-md">
...
const PricingCard = ({ name, price, period, description, features, cta, highlight }: PricingPlanProps) => (
  <div className={`bg-white border rounded-2xl p-7 flex flex-col transition-all hover:shadow-md ${highlight ? 'border-[#0EA472] shadow-md' : 'border-[#E8EDF2]'}`}>
    {highlight && (
    ...
    <button className={`w-full py-3 rounded-xl text-[13px] font-semibold transition-all hover:opacity-90 ${highlight ? 'bg-[#0D1B2A] text-white' : 'bg-white text-[#0D1B2A] border border-[#E8EDF2]'}`}>
      {cta}
    </button>
  </div>
);
      ...
      <section className="pt-32 pb-24 px-12 max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <div className="flex gap-3 mb-12">
            <Link href="/join" className="inline-flex items-center gap-2 bg-[#0D1B2A] text-white no-underline py-3.5 px-6 rounded-xl text-sm font-semibold hover:bg-[#1E3A5F] transition">
              Join for Free
              <ArrowRight />
            </Link>
            <Link href="/features" className="inline-flex items-center gap-2 bg-white text-[#0D1B2A] no-underline py-3.5 px-6 rounded-xl text-sm font-medium border border-[#E8EDF2] hover:bg-gray-50 transition">
              Explore Features
            </Link>
          </div>
        ...
        <div className="relative h-[400px] flex items-center justify-center">
          <div className="bg-white border border-[#E8EDF2] rounded-2xl p-5 w-full max-w-md shadow-lg">
    ...
    map.set(nums[i], i);
        ...
        <div className="space-y-3">
          {faqs.map((faq, i) => (
            <div key={i} className="bg-white border border-[#E8EDF2] rounded-xl overflow-hidden">
              <button
                className="w-full text-left px-5 py-4 flex items-center justify-between gap-4 text-[14px] font-medium text-[#0D1B2A] hover:bg-[#F8FAFB] transition"
          ...
          {subscribed ? (
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="px-6 py-3 rounded-xl text-sm font-semibold bg-[#0D1B2A] text-white hover:bg-[#1E3A5F] transition"
              >
                Subscribe →
              </button>
            </div>
      ...
      <section className="py-20 px-12 max-w-[800px] mx-auto text-center border-t border-[#E8EDF2] bg-white">
        ...
        <div className="flex gap-3 justify-center">
          <Link href="/join" className="inline-flex items-center gap-2 bg-[#0D1B2A] text-white no-underline py-3.5 px-7 rounded-xl text-sm font-semibold hover:bg-[#1E3A5F] transition">
            Create Free Account
            <ArrowRight />
          </Link>
          <Link href="/demo" className="inline-flex items-center bg-white text-[#0D1B2A] no-underline py-3.5 px-7 rounded-xl text-sm font-medium border border-[#E8EDF2] hover:bg-gray-50 transition">
            View Demo
          </Link>
        </div>
      </section>
      ...
      <footer className="border-t border-[#E8EDF2] bg-white py-10 px-12 flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-[#0EA472] to-[#059669] flex items-center justify-center text-white font-bold text-xs">
            D
          </div>
